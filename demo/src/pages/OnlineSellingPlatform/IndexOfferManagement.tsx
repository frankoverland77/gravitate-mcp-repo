...
import { buildFormulaPreview, PLACEHOLDER_VALUES, isPlaceholder, getPlaceholderDisplayText } from '../demos/grids/FormulaTemplates.data';
...
export function IndexOfferManagement() {
    ...
    const handleSaveOffer = useCallback((saveAsActive: boolean) => {
        ...
        console.log('Use Internal Override:', useInternalOverride);
        console.log('Internal Override:', internalOverride);
        console.log('Use External Override:', useExternalOverride);
        console.log('External Override:', externalOverride);
        console.log('Differential:', differential);
        console.log('Active:', saveAsActive);
        console.log('Internal Only:', isInternalOnly);
        console.log('Send Notification:', sendNotification);
        console.log('Valid For:', validFor);
        console.log('Weekend Rule:', weekendRule);
        console.log('Holiday Rule:', holidayRule);
        console.log('Payment Terms:', paymentTerms);
        console.log('Freight Terms:', freightTerms);
    ...
    const rowData = useMemo(() => [
        {
            ...
            terminal: 'Houston',
            product: '87 Gas',
            formulaTemplate: '90% Prior Day Argus CBOB USGC, 10% Prior Day Argus CBOB USGC, Less 10% OPIS Current Year RIN',
            differential: '0.02',
            status: 'Active',
    ...
    const analyticsColumnDefs = useMemo(() => [
        ...
        },
        {
            ...
            cellStyle: (params: any) => {
                if (params.data?.isSelected) {
                    return { backgroundColor: '#000000', color: '#ffffff', fontWeight: 600, textAlign: 'right' };
                }
        ...
        },
        {
            ...
            cellRenderer: (params: any) => {
                if (params.data?.isSelected) {
                    return (
                        <BBDTag style={{ backgroundColor: '#000000', color: '#ffffff', border: 'none', width: 'fit-content' }}>
                            Current
                        </BBDTag>
                    );
                }
        ...
        if (isFutureMode && viewMode === 'columns') {
            ...
            marketContextColumns.push(
                ...
                },
                {
                    ...
                    cellRenderer: (params: any) => {
                        ...
                        return <RankBadge rank={context.marketRank} totalCompetitors={context.totalCompetitors} size="small" />;
                    },
                }
            );
            ...
            marketContextColumns.push({
                ...
                cellRenderer: (params: any) => {
                    const context = marketContextData.find(m => m.offerId === params.data.id);
                    if (!context) return null;
                    return <RankBadge rank={context.marketRank} totalCompetitors={context.totalCompetitors} size="medium" />;
                },
            });
        }
    ...
    const agPropOverrides = useMemo(() => ({
        ...
        onRowClicked: (isFutureMode && (viewMode === 'panel' || viewMode === 'analytics')) ? (event: any) => {
            setSelectedRowForContext(event.data);
        } : undefined,
        rowClassRules: (isFutureMode && (viewMode === 'panel' || viewMode === 'analytics')) ? {
    ...
    return (
        <div style={{ height: '100%', display: 'flex', flexDirection: 'column', position: 'relative' }}>
            ...
            <Button
                ...
                size="large"
                onClick={() => {
                    console.log('View Settings button clicked, current state:', settingsDrawerVisible);
            ...
            >
                ...
                {showSaveTemplateForm ? (
                    ...
                    /* Main Form View */
                    <Vertical style={{ flex: 1, overflowY: 'auto', minHeight: 0, padding: '24px', gap: '24px' }}>
                    ...
                    <div>
                        <Texto style={{ fontSize: '12px', fontWeight: 700, marginBottom: '12px', margin: 0, textTransform: 'uppercase', letterSpacing: '1px', color: '#595959' }}>
                    ...
                    <div>
                        <Horizontal style={{ justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                            <Texto style={{ fontSize: '12px', fontWeight: 700, margin: 0, textTransform: 'uppercase', letterSpacing: '1px', color: '#595959' }}>
                                Components
                            </Texto>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                            ...
                            <div>
                                ...
                                <InputNumber
                                    ...
                                    controls={false}
                                />
                                <Texto style={{ fontSize: '11px', color: '#8c8c8c', marginTop: '8px', display: 'block' }}>
                    ...
                    <div>
                        ...
                        <div>
                            <Checkbox checked={isInternalOnly} onChange={(e) => setIsInternalOnly(e.target.checked)}>
                        ...
                        >
                            <Vertical style={{ gap: '12px' }}>
                                ...
                                >
                                    ...
                                    <Texto style={{ fontSize: '12px', color: '#8c8c8c', display: 'block', marginLeft: '24px' }}>
                                ...
                                <div
                                    style={{
                                        padding: '16px',
                                        border: featureMode === 'future-state' ? '2px solid #1890ff' : '1px solid #d9d9d9',
                                        borderRadius: '8px',
