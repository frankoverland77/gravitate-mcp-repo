...
import type { ManagedBenchmark, SelectedBenchmark } from '../../types/scenario.types'
...
interface ExistingBenchmarkSelectorProps {
  ...
  onManagedIdChange?: (id: string | undefined) => void
}
...
export function ExistingBenchmarkSelector({
  ...
  const handleSelectManaged = (benchmark: ManagedBenchmark) => {
    ...
    onManagedIdChange?.(benchmark.id)
  }
        ...
        <div className={styles.centerPanel}>
          <div className={styles.configSummary}>
            ...
            <div className={styles.configRow}>
              ...
              <Texto category='p1' weight='600'>
                {HIERARCHY_LABELS[selectedManaged.locationHierarchy] || selectedManaged.locationHierarchy}
              </Texto>
            </div>
