...
export const formulaTemplates: FormulaTemplate[] = [
    {
        ...
        usedInLocations: ['Columbus Terminal', 'Toledo Terminal', 'Cincinnati Rack'],
        category: 'Popular',
        totalUsage: 487,
        description: 'Most commonly used pricing formula for Columbus Terminal day deals. Combines Argus, OPIS, and Platts with standard differentials.',
    ...
    },
    {
        ...
        usedInLocations: ['Columbus Terminal', 'Toledo Terminal'],
        category: 'Partner',
        totalUsage: 342,
    ...
    },
    {
        ...
        usedInLocations: ['Columbus Terminal', 'Chicago Terminal'],
        category: 'Advanced',
        totalUsage: 156,
    ...
    },
    {
        ...
        usedInLocations: ['Columbus Terminal'],
        category: 'Seasonal',
        totalUsage: 89,
    ...
    },
    {
        ...
        usedInLocations: ['Columbus Terminal', 'Toledo Terminal', 'Detroit Hub'],
        category: 'Partner',
        totalUsage: 298,
    ...
    },
    {
        ...
        usedInLocations: ['Cincinnati Rack', 'Toledo Terminal', 'Chicago Terminal'],
        category: 'Popular',
        totalUsage: 412,
        description: 'Standard pricing formula for 93 octane premium gasoline at Cincinnati Rack.',
    ...
    },
    {
        ...
        usedInProducts: ['ULSD'],
        usedInLocations: ['Toledo Terminal', 'Detroit Hub', 'Cincinnati Rack'],
        category: 'Popular',
        totalUsage: 376,
    ...
    },
    {
        ...
        usedInLocations: ['Chicago Terminal'],
        category: 'Specialty',
        totalUsage: 203,
    ...
    },
    {
        ...
        contractType: 'Index Deal',
        usedInProducts: ['E85'],
        usedInLocations: ['Detroit Hub', 'Chicago Terminal'],
        category: 'Seasonal',
        totalUsage: 167,
    ...
    },
    {
        ...
        usedInLocations: ['Detroit Hub', 'Chicago Terminal', 'Toledo Terminal'],
        category: 'Regional',
        totalUsage: 278,
    ...
    },
    {
        ...
        contractType: 'Contract',
        usedInProducts: ['93 Premium'],
        usedInLocations: ['Toledo Terminal', 'Cincinnati Rack'],
        category: 'Seasonal',
        totalUsage: 234,
    ...
    },
    {
        ...
        contractType: 'Index Deal',
        usedInProducts: ['ULSD'],
        usedInLocations: ['Cincinnati Rack', 'Detroit Hub', 'Toledo Terminal'],
        category: 'Partner',
        totalUsage: 321,
    ...
    },
    {
        ...
        contractType: 'Day Deal',
        usedInProducts: ['87 GHL', 'CBOB', '93 Premium'],
        usedInLocations: ['Chicago Terminal', 'Columbus Terminal'],
        category: 'Partner',
        totalUsage: 395,
    ...
    },
    {
        ...
        contractType: 'Spot Deal',
        usedInProducts: ['87 GHL', 'CBOB'],
        usedInLocations: ['Toledo Terminal'],
        category: 'Advanced',
        totalUsage: 98,
    ...
    },
    {
        ...
        contractType: 'Contract',
        usedInProducts: ['87 GHL'],
        usedInLocations: ['Cincinnati Rack'],
        category: 'Advanced',
        totalUsage: 156,
    ...
    },
    {
        ...
        contractType: 'Index Deal',
        usedInProducts: ['ULSD'],
        usedInLocations: ['Chicago Terminal', 'Detroit Hub'],
        category: 'Specialty',
        totalUsage: 134,
    ...
    },
    {
        ...
        usedInLocations: ['Columbus Terminal', 'Toledo Terminal', 'Cincinnati Rack', 'Chicago Terminal'],
        category: 'Popular',
        totalUsage: 87,
    ...
    },
    {
        ...
        usedInLocations: ['Columbus Terminal', 'Toledo Terminal', 'Cincinnati Rack', 'Chicago Terminal', 'Detroit Hub'],
        category: 'Advanced',
        totalUsage: 45,
